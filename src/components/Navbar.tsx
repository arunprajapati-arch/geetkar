  ...
  return (
    <div className="w-full flex items-center justify-between md:p-4 py-6  z-10">
      ...
      <Link href={'/dashboard'} className='z-10'>
        <Button className='bg-yellow-400 rounded-full text-black text-md md:text-lg font-semibold p-2 md:px-4 md:py-6 hover:bg-yellow-500 z-10'>Get Started</Button>
      </Link>
    </div>
  )
}
