...
const GetinTouch: React.FC = () => {
    return (
        <section id='contact' className="py-12 bg-black text-gray-100">
                        ...
                        <div className="w-full md:w-2/3 p-6 flex flex-col justify-between relative">
                            ...
                            <div className="mb-4 relative z-10">
                                <div className="flex items-center mb-4">
                                    ...
                                    <div>
                                        <p className="text-yellow-300 text-xs font-medium uppercase tracking-wider">Phone / Whatsapp</p>
                                        <p className="text-white text-base">+91 8979531025</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white text-base">geetkar.in@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex justify-center md:justify-start space-x-4 mb-4">
                                    ...
                                    <a href="https://www.instagram.com/geetkar.in/" target='_blank' className="text-gray-400 hover:text-yellow-400 transition-colors duration-200">
